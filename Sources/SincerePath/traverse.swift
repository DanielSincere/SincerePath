...
extension SincerePath {
  ...
  ///   any subdirectory.
  public func leaves() throws -> [SincerePath] {
    try self.recursiveChildren()
      .filter { $0.isFile }
  }

  public func parent() -> SincerePath {
    return self + ".."
  }
  ...
  ///
  public func children() throws -> [SincerePath] {
  ...
  ///   any subdirectory.
  ///
  public func recursiveChildren() throws -> [SincerePath] {
  ...
  public var isDirectory: Bool {
    ...
    guard SincerePath.fileManager.fileExists(atPath: normalize().path, isDirectory: &directory) else {
      return false
    }
  ...
  public var isSymlink: Bool {
    do {
      let _ = try SincerePath.fileManager.destinationOfSymbolicLink(atPath: path)
      return true
    } catch {
      return false
    }
